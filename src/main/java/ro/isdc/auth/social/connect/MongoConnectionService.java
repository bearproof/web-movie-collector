 ...
 */
package ro.isdc.auth.social.connect;
...
public class MongoConnectionService implements ConnectionService {
	 ...
	 * 
	 * @see org.springframework.social.connect.mongo.ConnectionService#getMaxRank(java.lang.String,
	 *      java.lang.String)
	 */
	@Override
	...
	public void update(String userId, Connection<?> userConn) {
		...
		try {
			...
			Update update = Update.update("expireTime", mongoCnn.getExpireTime()).set("accessToken", mongoCnn.getAccessToken()).set("profileUrl", mongoCnn.getProfileUrl())
	...
	public void remove(String userId, ConnectionKey connectionKey) {
		...
		Query q = query(where("userId").is(userId).and("providerId").is(connectionKey.getProviderId()).and("providerUserId").is(connectionKey.getProviderUserId()));
	 ...
	 * 
	 * @see org.springframework.social.connect.mongo.ConnectionService#getConnection(java.lang.String,
